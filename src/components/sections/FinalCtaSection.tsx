    ...
    >
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <a
          ...
          className="cut mt-10 inline-flex items-center gap-2 bg-val-red px-10 py-5 font-ui text-base font-bold uppercase tracking-widest text-bg-base transition-all hover:brightness-110 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-val-red"
        >
          {t("ctaLabel")}
        </a>
